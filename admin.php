      ...
      <ul class="nav-links">
        ...
        <li>
          ...
          <i class='bx bx-book-alt' ></i>
            <span class="links_name">Total User</span>
          </a>
        </li>
        <li>
          <a href="#adminlist">
...
<div class="overview-boxes">
        <div class="box">
          <div class="right-side">
            ...
            <div class="number text-right"><?php  echo $TotalList ?></div>
          </div>
        </div>
        <div class="box">
          <div class="right-side">
            <div class="box-topic"> Admin List</div>
            <div class="number text-right "><?php echo $TotalAdmin ?></div>     
          </div>
        </div>
        <div class="box">
          <div class="right-side">
            <div class="box-topic"> Manager List</div>
            <div class="number text-right"><?php echo $TotalManager ?></div>     
          </div>
        </div>
        <div class="box">
          <div class="right-side">
    ...
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div class="col col-md-12 col-lg-12 col-xl-12">
        <div class="card" style="border-radius: 15px;">
          <div class="card-body p-4">
          <div class="row">
              <div class="col-6"><h2>Total User</h2></div>
              <div class="col-6 mr-5 text-end"> <form method="POST" action=""><a href="add.php" class="btn btn-primary">Create User</a></form></div>
            </div>
            <div class="d-flex text-black">          
                                ...
                                <tr>
                                   <td>" .$id."</td>
                                    ...
                                    <td>
                                        ...
                                        <a href='delete.php?index=".$index."' class='  btn btn-danger btn-sm' onclick='confirmation(event)' >Delete</a>
                                        <a href='makeAdmin.php?index=".$index."' class='  btn btn-warning btn-sm' onclick='confirmAdmin(event)' >Make Admin</a> 
                                    </td>
                                </tr>
                        ";$id++;}                      
                            $index++;
    ...
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div class="col col-md-12 col-lg-12 col-xl-12">
        <div class="card" style="border-radius: 15px;">
          <div class="card-body p-4">
          <div class="row">
              <div class="col-6"><h2>Admin List</h2></div>
            </div>
            <div class="d-flex text-black">          
            <table class="table table-bordered table-striped" style="margin-top:20px;">
                <thead>
    ...
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div class="col col-md-12 col-lg-12 col-xl-12">
        <div class="card" style="border-radius: 15px;">
          <div class="card-body p-4">
          <div class="row">
              <div class="col-6"><h2>Manager List</h2></div>
            </div>
            <div class="d-flex text-black">          
            <table class="table table-bordered table-striped" style="margin-top:20px;">
                <thead>
